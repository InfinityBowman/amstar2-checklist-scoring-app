        ...
        <Show when={!isHome()}>
          ...
          >
            <Show
              when={!props.open}
              fallback={
                <svg fill="none" stroke="currentColor" class="w-4 h-4" viewBox="0 0 20 20">
          ...
          fallback={
            isLikelyLoggedIn && authLoading() ?
              <>
                ...
                <button class="hover:bg-blue-600 px-2 py-1.5 rounded transition font-medium">Sign Out</button>
              </>
            : <>
                <A href="/signin" class="hover:bg-blue-600 px-2 py-1.5 rounded transition font-medium">
                  Sign In
                </A>
                <A href="/signup" class="hover:bg-blue-600 px-2 py-1.5 rounded transition font-medium">
                  Sign Up
                </A>
              </>
          }
