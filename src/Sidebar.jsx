      ...
      >
        ...
        <div class="flex-1 overflow-y-auto">
                ...
                <For each={props.checklists}>
                  {(c, idx) => (
                    <button
                      ...
                      class={`
                        w-full px-4 py-2.5 rounded-lg text-left transition-colors duration-150 group
          ...
          <div class="border-t border-gray-100 p-4">
            ...
            <div class="space-y-1">
              <button
                onClick={props.onDeleteCurrentChecklist}
                disabled={!props.currentId}
                class="w-full px-4 py-3 rounded-lg text-left transition-colors duration-150 text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-3 text-base"
              >
                <svg
                  class="w-5 h-5 text-gray-500"
                  fill="none"
